...
public record Permutation(int[] mapping) implements Element, Comparable<Permutation> {
    ...
    // Factory method delegates for backward compatibility

    /** @see PermutationFactory#identity(int) */
    public static Permutation identity(int n) {
        return PermutationFactory.identity(n);
    }

    /** @see PermutationFactory#cycle(int...) */
    public static Permutation cycle(int... elements) {
        return PermutationFactory.cycle(elements);
    }

    /** @see PermutationFactory#transposition(int, int, int) */
    public static Permutation transposition(int i, int j, int n) {
        return PermutationFactory.transposition(i, j, n);
    }

    /** @see PermutationFactory#fromCycles(int, List) */
    public static Permutation fromCycles(int n, List<List<Integer>> cycles) {
        return PermutationFactory.fromCycles(n, cycles);
    }
