...
public final class SubgroupGenerator {
    ...
    /**
     * @deprecated Use {@link SubgroupAnalyzer#normalizer(Group, Subgroup)} instead.
     *             This method will be removed in a future version.
     */
    @Deprecated(since = "1.1", forRemoval = true)
    public static <E extends Element> Subgroup<E> normalizer(Group<E> parent, Subgroup<E> subgroup) {
        return SubgroupAnalyzer.normalizer(parent, subgroup);
    }

    /**
     * @deprecated Use {@link SubgroupAnalyzer#centralizer(Group, Subgroup)}
    ...
    public static <E extends Element> Subgroup<E> centralizer(Group<E> parent, Subgroup<E> subgroup) {
        return SubgroupAnalyzer.centralizer(parent, subgroup);
    }

    /**
     * @deprecated Use {@link SubgroupAnalyzer#isNormal(Group, Subgroup)} instead.
     *             This method will be removed in a future version.
     */
    @Deprecated(since = "1.1", forRemoval = true)
    public static <E extends Element> boolean isNormal(Group<E> parent, Subgroup<E> subgroup) {
        return SubgroupAnalyzer.isNormal(parent, subgroup);
    }

    /**
     * @deprecated Use {@link SpecialSubgroups#maximalSubgroups(Group)} instead.
     *             This method will be removed in a future version.
     */
    @Deprecated(since = "1.1", forRemoval = true)
    public static <E extends Element> List<Subgroup<E>> maximalSubgroups(Group<E> parent) {
        return SpecialSubgroups.maximalSubgroups(parent);
    }

    /**
     * @deprecated Use {@link SpecialSubgroups#frattiniSubgroup(Group)} instead.
     *             This method will be removed in a future version.
     */
    @Deprecated(since = "1.1", forRemoval = true)
    public static <E extends Element> Subgroup<E> frattiniSubgroup(Group<E> parent) {
        return SpecialSubgroups.frattiniSubgroup(parent);
    }

    /**
     * @deprecated Use {@link SpecialSubgroups#center(Group)} instead. This method
     *             will be removed in a future version.
     */
    @Deprecated(since = "1.1", forRemoval = true)
    public static <E extends Element> Subgroup<E> center(Group<E> parent) {
        return SpecialSubgroups.center(parent);
    }

    /**
     * @deprecated Use {@link SpecialSubgroups#commutatorSubgroup(Group)} instead.
     *             This method will be removed in a future version.
     */
    @Deprecated(since = "1.1", forRemoval = true)
    public static <E extends Element> Subgroup<E> commutatorSubgroup(Group<E> parent) {
        return SpecialSubgroups.commutatorSubgroup(parent);
    }
}
