 ...
 * <h2>Key Concepts</h2>
 * <ul>
 * <li><b>Action</b>: A structure-preserving way for G to permute elements of
 * X</li>
 ...
 * <li><b>Free</b>: All stabilizers are trivial (only identity fixes
 * points)</li>
 * </ul>
 *
 ...
 * <ul>
 * <li><b>Conjugation</b>: G acts on itself by g · h = ghg⁻¹ (orbits = conjugacy
 * classes)</li>
